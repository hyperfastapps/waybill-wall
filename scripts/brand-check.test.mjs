...
const skipWithoutOgSkill = existsSync(join(TEMPLATE_ROOT, ".grok/skills/og/SKILL.md"))
  ? false
  : "og skill is not part of this app";
...
test("SKILL.md and AGENTS.md name the marker path and bound this script uses", { skip: skipWithoutOgSkill }, () => {
...
test("the sections that own the brand-task prohibition never affirm a wait", { skip: skipWithoutOgSkill }, () => {
...
test("SKILL.md tells the pass to self-check with the flag this CLI accepts", { skip: skipWithoutOgSkill }, () => {
